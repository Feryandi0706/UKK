...
<body class="bg-gray-200">
    <div class="container flex h-screen">
        <div class="block m-auto p-6 w-80 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <button class="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onclick="registerFunction()">Register</button>
        </div>
    </div>


    <script>
        var confirmed_pass = false;
        var confirmed_input = false;
        ...
        function registerFunction() {
            ...
            if (confirmed_input) {
                if (email.match(pattern)) {
                    confirmPassword();
                    if (confirmed_pass) {
                        location.href = "registerFunction.php?username=" + username + "&email=" + email + "&password=" + password;
                        // alert("sudah confirm");
                    }
                    else {
                        alert("Please confirm your valid password");
                    }
                } 
                else {
